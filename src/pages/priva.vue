    ...
    <main class="legal">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>
                            Privacy Policy of www.apimosa.es
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="privacy">
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                ...
                by the <a href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                        refers to Apimosa SL, Calle real, 66, Carmona, 41410 , Sevilla.</p>
                </li>
                ...
                <li><strong>Website</strong> refers to Apimosa, accessible from www.apimosa.es</li>
            ...
            <ul>
                ...
                <li>By phone number: 954143177</li>
            </ul>
        </div>
    </main>
    </Layout>
